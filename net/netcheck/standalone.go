...
// Standalone creates UDP sockets conforming to the given bind address and
// starts readers for the Client to use for cases where Client is being used in
// a standalone fashion. It must be called prior to starting any reports and is
// shut down by cancellation of the provided context. If both IPv4 and IPv6 fail
// to bind, errors will be returned, if one protocol can bind no error is
// returned.
